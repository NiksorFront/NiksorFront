...
1. **[Сервис центр](https://crm-by-niksor.ru/)** - На работе в небольшой веб-студии разрабатываю фронт CRM системы для сервис центра по ремонту принтеров, используя schadcn/ui и tailwind для визуальной части и React, Zustand и TypeScript для всей логики 
