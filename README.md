...
1. **[Студия Артемия Лебедева](https://beautiful-lego.ru/)** - Тестове задания на фронтендера-стажёра запрогал генератор лего аватаров, используя Vue и TypeScript
...
3. **[Синхронизации и Alliance Legal](https://russian-pravo.ru/)** - На фрилансе сверстал и запрогравировал сайт «Россия: Право сквозь века» со своим плеером и слайдером, используя Vue и JavaScript
